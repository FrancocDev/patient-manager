function Patient(props){
    ...
    <article className="bg-white w-full mt-4 rounded-md shadow-md p-6">
        ...
        <div className="flex gap-20 mt-3">
            ...
            <button type="button" className="bg-red-600 w-full p-2 text-white uppercase font-bold rounded-md hover:bg-red-800 cursor-pointer transition-all mt-4" onClick={() => props.setDelete(props.id)}>Delete patient</button>
        </div>
    </article>
    )
}
